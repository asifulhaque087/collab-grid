...
func OrderInvoiceEmail(order InvoiceOrder, items []InvoiceItem) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "</title></head><body style=\"margin: 0; font-family: sans-serif; background-color: #f1f5f9; padding: 24px;\"><div style=\"max-width: 640px; margin: 0 auto; background: #ffffff; border-radius: 8px; overflow: hidden;\"><div style=\"padding: 28px 32px; background-color: #0f172a;\"><span style=\"font-size: 24px; font-weight: bold; color: #ffffff;\">LootBoard</span> <span style=\"float: right; color: #94a3b8; font-size: 12px; letter-spacing: 2px;\">INVOICE</span></div><div style=\"padding: 28px 32px;\"><table style=\"width: 100%; border-collapse: collapse; margin-bottom: 24px;\"><tr><td style=\"font-size: 11px; color: #64748b; text-transform: uppercase; padding-bottom: 4px;\">Invoice Number</td><td rowspan=\"2\" style=\"text-align: right; vertical-align: top;\"><span style=\"display: inline-block; padding: 6px 14px; border-radius: 4px; font-size: 12px; font-weight: bold;\" bgcolor=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
